    ...
    >
      ...
      <div>
        ...
        <a
          ...
          className="group relative flex items-center justify-between w-full border hover:bg-[var(--color-secondary)]/5 transition-all duration-300 p-7 overflow-hidden cursor-pointer"
          style={borderMid}
        >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
          {linkPlatforms?.map((link) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative overflow-hidden border p-7 hover:bg-[var(--color-secondary)]/3 transition-all duration-300 cursor-pointer"
              style={borderFaint}
            >
